...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://ec2-13-126-9-144.ap-south-1.compute.amazonaws.com:8080/shawarmahouse/v1/gettokens?phoneNumber=${phoneNumber}`)
  ...
  const handlePlaceOrder = async (e) => {
    ...
    try {
        const updateResponse = await fetch("http://ec2-13-126-9-144.ap-south-1.compute.amazonaws.com:8080/shawarmahouse/v1/update", {
            method: "PUT",
            headers: {
    ...
    try {
        const response = await fetch(
            "http://ec2-13-126-9-144.ap-south-1.compute.amazonaws.com:8080/shawarmahouse/v1/createOrder",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
